...
describe("Check [get]/api/jokes endpoint functioning correctly", () => {
  ...
  test("receive No token message when token is missing", async () => {
  ...
  test("receive list of jokes with proper login and token", async () => {
...
describe("Check [Post]/api/auth/register endpoint functioning correctly", () => {
  test("missing username or password returns middleware", async () => {
  ...
  test("correct username returns object containing id,password,and username", async () => {
...
describe("Check [Post]/api/auth/login endpoint functioning correctly", () => {
  test("logging in with a user that is not registered returns invalid credentials", async () => {
  ...
  test("logging in with proper credentials returns welcome message and token", async () => {
